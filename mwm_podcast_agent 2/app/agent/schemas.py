...
class TopicRequest(BaseModel):
    theme: str = Field(..., description="High-level theme (e.g., 'AI at work and men's mental health')")
    audience: str = Field("YouTube general public", description="Audience description")
    count: int = Field(12, ge=1, le=30)
    include_finance_lens: bool = Field(True, description="Include behavioral finance / economic angles")
...
class ResearchRequest(BaseModel):
    ...
    require_min_citations: int = Field(10, ge=0, description="Minimum citation count for peer-reviewed sources")
